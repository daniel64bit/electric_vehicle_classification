...
# electric_vehicles documentation build
...
from electric_vehicles import __version__ as release

# -- Project information -----------------------------------------------------

project = "electric_vehicles"
author = "Kedro"
...
htmlhelp_basename = "electric_vehiclesdoc"
...
latex_documents = [
    (
        master_doc,
        "electric_vehicles.tex",
        "electric_vehicles Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "electric_vehicles",
        "Project electric_vehicles codebase.",
        "Data-Science",
    )
]
